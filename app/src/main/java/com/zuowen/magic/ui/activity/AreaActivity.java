...
public class AreaActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void initViews() {
        im_pic =  findView(R.id.im_pic);
        citypicker=findView(R.id.citypicker);
        et_grade = findView(R.id.et_grade);
        et_selector =  findView(R.id.et_selector);
        bt_start = findView(R.id.bt_start);
