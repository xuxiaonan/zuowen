...
public class LoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initViews() {
        cover_user_photo =  findView(R.id.cover_user_photo);
        user_name =  findView(R.id.user_name);
        input =  findView(R.id.input);
        user_pwd =  findView(R.id.user_pwd);
        btnlogin =  findView(R.id.btnlogin);
        forget_psw =  findView(R.id.forget_psw);
        regist_account = findView(R.id.regist_account);
    ...
    private void loginMain() {
        btnlogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MagicHttpClient.getInstance(LoginActivity.this).post(UrlJsonUtil.URL + UrlJsonUtil.ZWUSER + UrlJsonUtil.LOGIN,
